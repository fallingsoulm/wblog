...
public class JueJinNewsSpiderHandler extends AbstractNewsSpiderHandler {
...
//    }
    ...
    protected String getHtmlContent(Integer page) {
        ...
        String body = HttpUtil.createPost("https://api.juejin.cn/recommend_api/v1/article/recommend_all_feed")
    ...
    protected String parserContent(String html) {
        return Jsoup.parse(html).select("div.markdown-body").html();
    }
