...
(function(mod) {
  ...
  // Read and send the height of line widgets associated with the
  // given line.
  ...
  // left (we don't send arrays for lines without spans).
  ...
  // Used to send marked span information in the history.
